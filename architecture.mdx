...
These are dynamically computed from the oracle CHANSE/USD price and configured USD targets when each token is created.
...
| Sell fee | 2.5% (250 bps) | Deducted from CHANSE output after curve math |
...
2. Users buy/sell on curve      │  price rises as supply decreases
   (0.5% buy fee, 2.5% sell)   │  fees accumulate in CHANSE reserves
                                │
