...
description: 'Standard REST endpoints for querying ansemchain state'
---
...
This is the REST interface running on the primary validator node. All endpoints return JSON.
...
{
  "code": 5,
  "message": "rpc error: code = NotFound desc = account ansem1... not found",
  "details": []
}
```
