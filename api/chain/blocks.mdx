...
Retrieve block headers, transaction lists, and consensus metadata for any block on ansemchain.
...
| Field | Description |
|-------|-------------|
| `block.header.chain_id` | Chain identifier (`ansem-1` for mainnet) |
...
```bash wrap
curl https://rest.ansemchain.fun/cosmos/base/tendermint/v1beta1/blocks/152340
```
...
```bash wrap
curl -s https://rest.ansemchain.fun/cosmos/base/tendermint/v1beta1/blocks/152340 \
