...
The `ansem init` command creates a complete CosmWasm contract project with all the necessary files and configurations.

## Usage

```bash wrap
ansem init <project-name>
```
...
```bash wrap
ansem init my-token --template cw20
```
