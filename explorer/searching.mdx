...
The ansemchain Explorer supports searching by several identifiers. Each search type takes you to the appropriate detail page.
...
Look up any ansemchain address (starts with `ansem1`) to view:

- **Balances** -- Native CHANSE and ANSEM, plus all CW20 token holdings
...
Validator addresses start with `ansemvaloper1` and show:
...
| `ansem1...` address | Accounts section, paste address |
| `ansemvaloper1...` address | Staking section, find validator |
