...
description: 'Browse blocks, transactions, accounts, and contracts on ansemchain'
---

# Explorer Overview

The ansemchain Explorer is a web-based interface for browsing all on-chain activity. You can view blocks, transactions, accounts, validators, governance proposals, smart contracts, and bridge operations.
...
- Current CHANSE price and market chart
- Price calculator (CHANSE to USD)
...
- Native CHANSE and ANSEM balances
